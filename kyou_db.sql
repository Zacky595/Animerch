...
-- Membuang data untuk tabel kyou_db.carts: ~4 rows (lebih kurang)
...
-- Membuang data untuk tabel kyou_db.migrations: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel kyou_db.orders: ~27 rows (lebih kurang)
INSERT INTO `orders` (`id`, `user_id`, `product_id`, `quantity`, `total_price`, `status`, `delivery_status`, `shipping_address`, `shipping_courier`, `shipping_cost`, `tax_fee`, `insurance_fee`, `admin_fee`, `snap_token`, `created_at`, `updated_at`) VALUES
	...
	(24, 3, 29, 1, 138500, 'Paid', 'shipping', 'jalan', 'JNE YES', 24000, 11000, 2500, 1000, '6581cd71-1b79-4846-8f28-d066076ed150', '2025-12-17 05:50:29', '2025-12-17 06:03:26'),
	...
	(36, 3, 31, 1, 1137500, 'Paid', 'processing', 'jalan', 'JNE YES', 24000, 110000, 2500, 1000, 'df92753f-0c72-4a17-b592-1a00d6178a30', '2025-12-17 21:46:49', '2025-12-17 21:47:02');
...
-- Membuang data untuk tabel kyou_db.order_items: ~27 rows (lebih kurang)
...
-- Membuang data untuk tabel kyou_db.products: ~10 rows (lebih kurang)
INSERT INTO `products` (`id`, `name`, `description`, `price`, `stock`, `category`, `image`, `created_at`, `updated_at`) VALUES
	...
	(3, 'One Piece Luffy Gear 5', 'Deskripsi keren untuk One Piece Luffy Gear 5', 1500000, 2, 'merch', 'products/ZbkYJ3KjtzPtrOfoqDlOfXoGkSWHH42AhPeA5ISE.jpg', '2025-12-11 04:26:26', '2025-12-16 05:11:01'),
	...
	(29, 'Poster Kimetsu no Yaiba', 'Poster', 100000, 6, 'merch', 'products/uqJ1yMQBI2c7KwSw0ShK8GinlCcZJy6rzY98FDoe.jpg', '2025-12-16 04:00:04', '2025-12-17 21:15:30'),
	...
	(34, 'Figure Citlali - Genshin Impact', 'Figure Citlali Genshin Impact', 1650000, 5, 'merch', 'products/9F4pGd5TIC3b8AjE7Qr7MoPFuD56sJNMiPnVNToU.webp', '2025-12-21 07:11:29', '2025-12-21 07:11:29'),
	...
	(37, 'Elysia Herrscher Of Human Ego - Series Jacket', 'Jacket Honkai Impact 3', 2000000, 1, 'fashion', 'products/JpV7G1QpchahbFutwgZxRrTtgsEZoEpDuHg6qsUJ.webp', '2025-12-21 07:14:30', '2025-12-21 07:14:30'),
	(38, 'Kamen Rider Ex-Aid - Series Jacket', 'Jacket Tokusatsu', 800000, 10, 'fashion', 'products/kl4tKWbFnaK2bQggp8WjqkQtrIJ55X1cRoQI7pYX.webp', '2025-12-21 07:15:28', '2025-12-21 07:15:28'),
	...
	(40, 'Figure - Oguri Cap 20cm - Uma Musume Pretty Darby', 'Figure - Oguri Cap 20cm', 1500000, 3, 'merch', 'products/XChPNDWjecViAYypKyyPEjzfHUhm9u8OoKyRTPkx.webp', '2025-12-21 07:18:07', '2025-12-21 07:18:07'),
	(41, 'Figure - Orfevre - Uma Musume Pretty Darby', 'Figure Orfevre', 1890000, 5, 'merch', 'products/rgF3TYAS9k4Q6CYJhF3iKhC6lfmlHn19elexLMas.webp', '2025-12-21 07:19:16', '2025-12-21 07:19:16'),
	(42, 'Figure - Kitasan Black - Uma Musume Pretty Darby', 'Figure Kitasan Black', 2500000, 8, 'merch', 'products/97BuHN4hKl5cHQARmRtUb0Mhux8pNzMAcuCOMVzL.webp', '2025-12-21 07:20:02', '2025-12-21 07:20:02'),
	(43, 'Nendoroid - Tamamo Cross - Uma Musume Pretty Darby', 'nyenyenye bapakna tukang batagor', 20000000, 1, 'merch', 'products/Oj0IksZfQW12n1aDilCEodXnSUa1mUGloJ3M30j8.webp', '2025-12-21 07:20:57', '2025-12-21 07:20:57'),
	(44, 'Hololive English - Keyboard', 'Hololive English Keyboard', 1250000, 8, 'elektronik', 'products/EnkVyV3N6evIbjmPMAihRIUIK5GYkoxgLAlEc0MJ.webp', '2025-12-21 07:21:56', '2025-12-21 07:21:56');
...
-- Membuang data untuk tabel kyou_db.reviews: ~9 rows (lebih kurang)
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('0YgqLncM497s4qCt9d2TpaN7pkNac2Y42tH8NWIR', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1766323968),
	('M7lL7Sg81kA25EIkLUF0AR8US7ONAGY1QFqmFjhn', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1766326921),
	('wn7QMiHSzpjUVFfiuOGWpLZQJjFn8QCtppRVE8fs', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1766324771);
...
-- Membuang data untuk tabel kyou_db.users: ~5 rows (lebih kurang)
INSERT INTO `users` (`id`, `name`, `email`, `image`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(3, 'zacky', 'tes01@gmail.com', 'profiles/0Jc6RCTKQXSQngxIOXH3vCCDyZyeJUE2Rh9oG9Qt.jpg', 'admin', NULL, '$2y$12$PPngUYXfVwNw2gedT19CduWAYVjigvGfy1ip4fn7cdih1wBfQARXi', NULL, '2025-12-11 04:27:32', '2025-12-17 11:37:24'),
